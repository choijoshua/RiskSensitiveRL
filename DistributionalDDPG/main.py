...
from distddpg import DistributionalDDPG
...
def train(env, hyperparameters, actor_model, critic_model, timesteps, graph_):
	...
	model = DistributionalDDPG(env=env, actor_class=ActorNetwork, critic_class=CriticNetwork, **hyperparameters)
	...
	# Train the model with a specified total timesteps
...
def rollout(env, actor_model, render=False):
	...
	agent = DistributionalDDPG(env=env, actor_class=ActorNetwork, critic_class=CriticNetwork)
